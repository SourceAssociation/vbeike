...
require_once 'rr_config.inc.php'; #Include configure resources
 ...
 class RenrenRestApiService extends HttpRequestService{
	...
	public function __construct(){
		...
		if(empty($this->_config->APIURL) || empty($this->_config->APIKey) || empty($this->_config->SecretKey)){
			throw new exception('Invalid API URL or API key or Secret key, please check rr_config.inc.php');
		}
